...
class Delegate<Ret(Args...)> {
    ...
    [[nodiscard]] auto wrap(std::index_sequence<Index...>) noexcept {
        return [](const void *, Args... args) -> Ret {
            ...
            return static_cast<Ret>(std::invoke(Candidate, std::forward<entt::type_list_element_t<Index, entt::type_list<Args...>>>(std::get<Index>(arguments))...));
        };
    }
    ...
    [[nodiscard]] auto wrap(Type &, std::index_sequence<Index...>) noexcept {
        return [](const void *payload, Args... args) -> Ret {
            [[maybe_unused]] const auto arguments = std::forward_as_tuple(std::forward<Args>(args)...);
            Type *curr = static_cast<Type *>(const_cast<entt::constness_as_t<void, Type> *>(payload));
            return static_cast<Ret>(std::invoke(Candidate, *curr, std::forward<entt::type_list_element_t<Index, entt::type_list<Args...>>>(std::get<Index>(arguments))...));
        };
    }
 ...
 */
    ...
    Delegate(entt::connect_arg_t<Candidate>, Type &&...value_or_instance) noexcept {
    ...
    void connect() noexcept {
        ...
        if constexpr (std::is_invocable_r_v<Ret, decltype(Candidate), Args...>) {
            ...
            fn = wrap<Candidate>(index_sequence_for<entt::type_list_element_t<0, entt::type_list<Args...>>>(function_pointer_t<decltype(Candidate)>{}));
        } else {
...
///
template<auto Candidate>
Delegate(entt::connect_arg_t<Candidate>) -> Delegate<std::remove_pointer_t<function_pointer_t<decltype(Candidate)>>>;
...
///
template<auto Candidate, typename Type>
Delegate(entt::connect_arg_t<Candidate>, Type &&) -> Delegate<std::remove_pointer_t<function_pointer_t<decltype(Candidate), Type>>>;
