...
module Vite.Renderer.ShaderCompiler;

///
/// @brief Workaround for C++ Modules
/// @details Simply copied from <shaderc/shaderc.hpp>
///
namespace shaderc {
...
namespace Hedron::ShaderCompiler {
...
/// Default
///
vector<uint32> Compile(const string &name, ShaderType type, const string &source, bool optimize) {
