...
public:
    ...
    // Methods
    static void AddBorder(float s, const Position2D &position, const Size2D &size, const Color &color) {
    ...
    static void AddPanel(const Position2D &position, const Size2D &size, const Color &color, float bevel, float innerAlpha) {
    ...
    static void AddLine(const Position2D &start, const Position2D &end, const Color &color) {
        UIRenderer::Instance().DrawLine({ start.X, start.Y, 0.0f }, { end.X, end.Y, 0.0f }, { color.Red, color.Green, color.Blue, color.Alpha });
    }
    static void AddRectangle(const Position2D &position, const Size2D &size, const Color &color) {
    ...
    static void AddImage(const Position2D &position, const Size2D &size, const Reference<Texture> &image) {
        UIRenderer::Instance().DrawRectangle({ position.X, position.Y, 0.0f }, { size.Width, size.Height }, image, { 1.0f, 1.0f, 1.0f, 1.0f });
    }
    static void AddText(const Position2D &position, const string &text, const Color &color, Font *font) {
