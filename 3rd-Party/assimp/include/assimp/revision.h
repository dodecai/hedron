...
#define GitVersion 0xa37d748 //0x@GIT_COMMIT_HASH@
#define GitBranch "@GIT_BRANCH@"

#define VER_MAJOR 5 //@ASSIMP_VERSION_MAJOR@
#define VER_MINOR 4 //@ASSIMP_VERSION_MINOR@
#define VER_PATCH 2 //@ASSIMP_VERSION_PATCH@
...
#endif
#define VER_COPYRIGHT_STR           "\xA9 2006-2024"
